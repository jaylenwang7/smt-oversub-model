...
**Bar-chart companion** (same naive R=1.0 setting as [01 `no_oversub_comparison`](../../configs/oversub_analysis/genoa/no_oversub_comparison.jsonc), plus two extra bars for the geomean (`m=0.75`) and **low** sweep marker (`m=0.65`) on no-SMT linear):

**Config**: [`configs/oversub_analysis/genoa/linear/no_oversub_comparison_discount_markers.jsonc`](../../configs/oversub_analysis/genoa/linear/no_oversub_comparison_discount_markers.jsonc)

**Output**: `results/oversub_analysis/genoa/linear/no_oversub_comparison_discount_markers/`
...
# Same sanity setting as a 5-bar compare (geomean + low marker m=0.65 vs [01]-style bars)
python -m smt_oversub_model configs/oversub_analysis/genoa/linear/no_oversub_comparison_discount_markers.jsonc
```
...
A **five-bar compare** (same three configurations as [`no_oversub_comparison`](../../configs/oversub_analysis/genoa/no_oversub_comparison.jsonc), plus no-SMT linear at the geomean and **low** (`m=0.65`) sweep markers) is generated by [`no_oversub_comparison_discount_markers.jsonc`](../../configs/oversub_analysis/genoa/linear/no_oversub_comparison_discount_markers.jsonc); see `results/.../plots/`.
